...
from breze.arch.model.rnn import rnn
    # , lstm
from breze.learn.base import SupervisedModel, UnsupervisedModel
...
class RnnAE(GenericRnnAE, UnsupervisedModel): pass
...
class LadderRnn(GenericRnnAE, DenoisingMixin, SupervisedModel):
